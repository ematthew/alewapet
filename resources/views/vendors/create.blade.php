        ...
        <div class="row">
           <div class="col-lg-12 margin-tb">
             ...
             <div class="pull-right">
                <a class="btn btn-primary" href="{{ url('vendors') }}"> Back</a>
            </div>
          </div>
       </div>
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="registration_no" class="form-control" placeholder="registration_no">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>AMOUNT PAID:</strong>
                <input type="text" name="amount_paid" class="form-control" placeholder="amount_paid">
            </div>
        </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="date" name="date_of_payment" class="form-control" placeholder="date_of_payment">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
